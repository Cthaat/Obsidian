...
和商品中建立头寸（可以是方向性或相对价值）。投资决策通常依赖于管理者对**经济和政治**的自上而下观点，例如对经济增长、利率、通胀、政府政策、地缘政治等的看法。资产类别内部或它们之间的相对估值也可能在投资过程中起到作用。
