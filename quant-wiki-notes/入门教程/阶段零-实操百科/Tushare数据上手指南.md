...
1. 打开 [https://www.tushare.pro/](https://www.tushare.pro/) 注册登录。  
2. 在个人主页 / 接口 TOKEN 处复制 token。  
3. 浏览 **文档**：安装、权限中心、积分说明。  
4. （可选）按需参与社区积分任务或套餐——**先确认你需要的接口权限**再投入时间。  
...
[[数据源全景与选型]] [[Python量化环境搭建]] [[TuShare数据接口]] [[复权与公司行动实操]] [[研究笔记与实验工作流]]
