...
> [!note] 💡 概念解析
> 限价单(Limit Order)是以指定价格或更优价格买入/卖出的订单。买限价单以不高于指定价格成交，卖限价单以不低于指定价格成交。优点：价格确定；缺点：可能无法成交。
在金融市场中，限价单是指以指定价格或更优价格买入或卖出股票

> [!note] 股票
> 公司所有权的凭证，代表股东对公司资产和收益的权益
或其他证券的指令。这一规定使交易者能够更好地控制交易价格。限价单可以设置在买入或卖出订单上：
