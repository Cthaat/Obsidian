...
> [!note] 💡 概念解析
> 变化率(ROC)衡量资产价格在特定期间内的百分比变化。ROC = (当前价格 - N期前价格) / N期前价格 × 100%。用于判断动量和趋势。
...
> [!important]
> 如果某个指数或其他广泛市场证券的变化率超过50%，投资者应警惕可能的泡沫。
...
在财务领域，变化率的计算也可以通过时间的收益来进行。在这种情况下，公式使用股票

> 公司所有权的凭证，代表股东对公司资产和收益的权益
或指数的当前价值，并将其除以前一时期的价值。减去1后将结果乘以100以给出百分比表示：
