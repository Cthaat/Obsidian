...
> [!note] 💡 概念解析
> 并购(M&A)是公司合并或收购其他公司的行为。目的：扩大规模、进入新市场、获得技术、协同效应。可能涉及现金、股票或混合支付。
...
[3] McKinsey & Company. "[Done Deal? Why Many Large Transactions Fail to Cross the Finish Line](https://www.mckinsey.com/business-functions/strategy-and-corporate-金融术语/our-insights/done-deal-why-many-large-transactions-fail-to-cross-the-finish-line)."
