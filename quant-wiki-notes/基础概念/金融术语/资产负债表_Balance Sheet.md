...
> [!note] 💡 概念解析
> 资产负债表反映公司在特定时点的财务状况。公式：资产=负债+股东权益。展示公司拥有的(资产)和欠的(负债)。
...
负债是公司对外部方的任何欠款，包括必须支付给供应商的账单、支付给债权人的债券

> 政府或企业发行的债务工具，承诺按期支付利息并到期偿还本金
利息、租金、水电费和薪资。流动负债是在一年内到期的，按到期日顺序列出。长期负债则在一年以后才到期。
...
资产负债表还用于获取资本。公司通常必须向贷款方提供资产负债表，以获得商业贷款。在寻求私募

> 向特定投资者（如对冲基金

> 采用多种策略（包括杠杆、卖空等）的投资基金
、银行）非公开发行证券
股权融资时，公司通常也需要向私人投资者提供资产负债表。在这两种情况下，外部方希望评估公司的财务健康状况、信用度以及公司是否能够偿还短期债务。
