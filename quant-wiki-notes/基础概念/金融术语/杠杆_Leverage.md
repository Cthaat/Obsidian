...
> [!note] 💡 概念解析
> 杠杆是用借入资金放大投资规模。杠杆率=总资产/自有资金。杠杆放大收益也放大风险，亏损可能超过本金。
...
- 公司可以使用杠杆来为其资产融资。换句话说，公司可以使用债务融资来投资于业务运营，以影响增长，而不是发行股票
...
> [!important]
> 使用 EBITDA 的一个问题是它不能准确反映收益。这是因为它不包括必须考虑的费用。它是一些公司用来创造更高盈利能力假象的非 GAAP 指标。
...
> [!important]
> 财务比率在与一段时间内或与竞争对手进行比较时最有价值。在分析不同公司的杠杆比率时请注意，因为不同的行业可能需要不同的融资构成。
...
这些类型的杠杆头寸经常发生。例如，Apple (AAPL) 在 2022 年 3 月第三次发行了 47 亿美元的绿色债券

> [!note] 债券
> 政府或企业发行的债务工具，承诺按期支付利息并到期偿还本金
。[2] 通过使用债务融资，Apple 可以扩大低碳制造并创造回收机会，同时使用无碳铝。当产生的收入多于发行债券产生的债务时，这种类型的杠杆策略可以奏效。
