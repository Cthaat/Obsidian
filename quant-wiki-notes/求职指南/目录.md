...
> [!note] 核心问题
> 本区有多篇译文与路径文，但缺总导航。本目录帮你**按角色选读**，并限制刷面经时间，避免替代研究闭环。完整结构化（刷题路径、国内岗位地图）见 [[全库百科化路线图]] **P4**。

## 怎么用本区

1. 先定目标角色：研究员 / 交易员 / 开发 / 混岗。  
2. 读 1 篇路径总述 + 1 篇简历/面试。  
3. 作品集优先：阶段零研究包 + 毕业项目，而不是只背题。  
4. **每周面经时限**（建议 ≤3h），其余时间做可展示项目。  
...
[[全库百科化路线图]] [[毕业项目实操模板]] [[行业洞察/概述]] [[学习网站与社区导航]]
