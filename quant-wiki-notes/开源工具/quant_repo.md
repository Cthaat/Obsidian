...
- [statistics](https://docs.python.org/3/学习资源/statistics.html) - Python 内置的基础统计计算库。
...
- [OpenBB Terminal](https://github.com/OpenBB-金融术语/OpenBBTerminal) - 人人可用的投资研究终端。
...
- [algobroker](https://github.com/joe量化交易/algobroker) - 一个执行引擎，用于算法交易。
...
- [jesse](https://github.com/jesse-人工智能/jesse) - 先进的加密货币交易机器人，采用 Python 编写。
- [rqalpha](https://github.com/rice量化交易/rqalpha) - 可扩展、可替换的 Python 算法回测 & 交易框架，支持多种金融产品。
...
- [Trading Strategy](https://github.com/tradingstrategy-人工智能/getting-started) - TradingStrategy.ai 是一个去中心化金融 (DeFi) 研究、回测、实盘交易及投资管理框架。
...
- [finance](https://pypi.org/project/金融术语/) - 金融风险计算，着重通过类与运算符重载提升易用性。
...
- [Facebook Prophet](https://github.com/face经典书籍/prophet) - 针对具有多重季节性且线性或非线性增长的时间序列数据进行高质量预测的工具。
...
- [googlefinance](https://github.com/hongtaoc人工智能/googlefinance) - 从 Google Finance API 获取实时股票数据的 Python 模块。
...
- [Trading Strategy](https://github.com/tradingstrategy-人工智能/trading-strategy/) - 下载去中心化交易所和借贷协议（DeFi）的价格数据。
...
- [tidyfinance](https://github.com/tidy-金融术语/r-tidyfinance) - 将原始金融数据转换为整洁（tidy）格式，包含日期转换、规模因子等，便于后续研究。
...
- [TradeFrame](https://github.com/rburkholder/trade-frame) - C++17 交易框架/库（含示例），可测试期权交易自动化策略，内含 [Option Greeks/IV](https://github.com/rburkholder/trade-frame/tree/量化大师/lib/TFOptions) 计算库。
